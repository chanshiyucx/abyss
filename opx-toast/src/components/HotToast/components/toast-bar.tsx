...
export const ToastBar: React.FC<ToastBarProps> = React.memo(({ toast, position, ...props }) => {
  // 通过 ref 来计算元素的尺寸
  ...
  const animationStyle = toast?.height ? getAnimationStyle(position, toast.visible) : { opacity: 0 };
